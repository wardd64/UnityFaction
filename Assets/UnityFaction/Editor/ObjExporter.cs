...
public class ObjExporter {
    ...
    public static void DoExport(GameObject g, bool makeSubmeshes, string fileName) {

        string meshName = g.name;
    ...
    [MenuItem("UnityFaction/Export selected mesh")]
    static void DoExportWSubmeshes() {
        ExportSelection(true);
    }

    static void ExportSelection(bool makeSubmeshes) {
